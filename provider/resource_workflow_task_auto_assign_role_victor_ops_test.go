...
func TestAccResourceWorkflowTaskAutoAssignRoleVictorOps(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep {
			...
			{
				Config: testAccResourceWorkflowTaskAutoAssignRoleVictorOpsUpdateConfig(rName),
			},
		},
	})
}
...
func testAccResourceWorkflowTaskAutoAssignRoleVictorOpsUpdateConfig(name string) string {
	return fmt.Sprintf(`
resource "rootly_workflow_incident" "foo" {
  	name = "%s"
	trigger_params {
