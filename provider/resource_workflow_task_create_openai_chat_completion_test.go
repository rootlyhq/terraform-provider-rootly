...
func TestAccResourceWorkflowTaskCreateOpenaiChatCompletion(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep {
			...
			{
				Config: testAccResourceWorkflowTaskCreateOpenaiChatCompletionUpdateConfig(rName),
			},
		},
	})
}
...
func testAccResourceWorkflowTaskCreateOpenaiChatCompletionUpdateConfig(name string) string {
	return fmt.Sprintf(`
resource "rootly_workflow_incident" "foo" {
  	name = "%s"
	trigger_params {
