		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("rootly_edge_connector_action.test", "name", randomActionName),
					resource.TestCheckResourceAttr("rootly_edge_connector_action.test", "action_type", "script"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("rootly_edge_connector_action.test", "id"),
					resource.TestCheckResourceAttr("rootly_edge_connector_action.test", "name", randomActionNameUpdated),
					resource.TestCheckResourceAttr("rootly_edge_connector_action.test", "action_type", "http"),
				),
			},
		},
	})
