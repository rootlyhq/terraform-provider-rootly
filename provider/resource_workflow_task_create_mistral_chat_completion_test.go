...
func TestAccResourceWorkflowTaskCreateMistralChatCompletion(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep {
			...
			{
				Config: testAccResourceWorkflowTaskCreateMistralChatCompletionUpdateConfig(rName),
			},
		},
	})
}
...
func testAccResourceWorkflowTaskCreateMistralChatCompletionUpdateConfig(name string) string {
	return fmt.Sprintf(`
resource "rootly_workflow_incident" "foo" {
  	name = "%s"
	trigger_params {
