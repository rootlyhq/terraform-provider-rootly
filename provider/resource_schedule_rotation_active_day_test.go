...
func TestAccResourceScheduleRotationActiveDay(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccResourceScheduleRotationActiveDayConfig(scheduleName, rotationName),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("rootly_schedule_rotation_active_day.test", "id"),
				),
			},
		},
	})
...
func testAccResourceScheduleRotationActiveDayConfig(scheduleName, rotationName string) string {
	return fmt.Sprintf(`
...
resource "rootly_schedule_rotation_active_day" "test" {
