...
func TestAccResourceWorkflowTaskAutoAssignRoleRootly(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep {
			...
			{
				Config: testAccResourceWorkflowTaskAutoAssignRoleRootlyUpdateConfig(rName),
			},
		},
	})
}
...
func testAccResourceWorkflowTaskAutoAssignRoleRootlyUpdateConfig(name string) string {
	return fmt.Sprintf(`
resource "rootly_workflow_incident" "foo" {
  	name = "%s"
	trigger_params {
