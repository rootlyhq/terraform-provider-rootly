...
function hasSlug(resourceSchema) {
  return resourceSchema.properties && resourceSchema.properties.slug;
}
...
module.exports = (name, resourceSchema, requiredFields, pathIdField) => {
  ...
  const hasValidation = allSchemaFields.includes("validation.StringInSlice");
