...
- `alert_broadcast_enabled` (Boolean) Filter by alert broadcast enabled.
- `backstage_id` (String) The Backstage entity id to filter by. eg: :namespace/:kind/:entity_name.
- `cortex_id` (String) The Cortex group id to filter by.
- `external_id` (String) The external id to filter by.
- `incident_broadcast_enabled` (Boolean) Filter by incident broadcast enabled.
- `name` (String) The name of the service to filter by.
- `slug` (String) The slug of the service to filter by.
