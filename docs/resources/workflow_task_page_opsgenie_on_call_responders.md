...
Using `terraform import`, import rootly_workflow_task_page_opsgenie_on_call_responders using the `id`. For example:

```console
% terraform import rootly_workflow_task_page_opsgenie_on_call_responders.my-resource 00000000-0000-0000-0000-000000000000
```
