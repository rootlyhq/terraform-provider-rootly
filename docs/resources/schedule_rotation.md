...
Using `terraform import`, import rootly_schedule_rotation using the `id`. For example:

```console
% terraform import rootly_schedule_rotation.my-resource 00000000-0000-0000-0000-000000000000
```
