...
Using `terraform import`, import rootly_workflow_task_snapshot_looker_look using the `id`. For example:

```console
% terraform import rootly_workflow_task_snapshot_looker_look.my-resource 00000000-0000-0000-0000-000000000000
```
