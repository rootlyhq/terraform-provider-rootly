...
# Resource (rootly_workflow_task_invite_to_microsoft_teams_channel_rootly)
...
rootly_workflow_task_invite_to_microsoft_teams_channel_rootly can be imported using the [`import` command](https://developer.hashicorp.com/terraform/cli/commands/import).

```sh
terraform import rootly_workflow_task_invite_to_microsoft_teams_channel_rootly.primary a816421c-6ceb-481a-87c4-585e47451f24
```
...
```terraform
import {
  to = rootly_workflow_task_invite_to_microsoft_teams_channel_rootly.primary
