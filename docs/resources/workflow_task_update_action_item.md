...
Using `terraform import`, import rootly_workflow_task_update_action_item using the `id`. For example:

```console
% terraform import rootly_workflow_task_update_action_item.my-resource 00000000-0000-0000-0000-000000000000
```
