...
In Terraform v1.5.0 and later, use an [`import` block](https://developer.hashicorp.com/terraform/language/import) to import rootly_workflow_action_item using the `id`. For example:

```terraform
import {
  to = rootly_workflow_action_item.my-resource
  id = "00000000-0000-0000-0000-000000000000"
}
```

Using `terraform import`, import rootly_workflow_action_item using the `id`. For example:

```console
% terraform import rootly_workflow_action_item.my-resource 00000000-0000-0000-0000-000000000000
```
