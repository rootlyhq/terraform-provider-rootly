...
Using `terraform import`, import rootly_workflow_task_create_jira_issue using the `id`. For example:

```console
% terraform import rootly_workflow_task_create_jira_issue.my-resource 00000000-0000-0000-0000-000000000000
```
