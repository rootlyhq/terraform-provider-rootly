...
In Terraform v1.5.0 and later, use an [`import` block](https://developer.hashicorp.com/terraform/language/import) to import rootly_schedule_rotation_user using the `id`. For example:

```terraform
import {
  to rootly_schedule_rotation_user.my-resource
  id = "00000000-0000-0000-0000-000000000000"
}
```

Using `terraform import`, import rootly_schedule_rotation_user using the `id`. For example:

```console
% terraform import rootly_schedule_rotation_user.my-resource 00000000-0000-0000-0000-000000000000
```
