...
Using `terraform import`, import rootly_live_call_router using the `id`. For example:

```console
% terraform import rootly_live_call_router.my-resource 00000000-0000-0000-0000-000000000000
```
