...
Using `terraform import`, import rootly_workflow_task_send_slack_blocks using the `id`. For example:

```console
% terraform import rootly_workflow_task_send_slack_blocks.my-resource 00000000-0000-0000-0000-000000000000
```
