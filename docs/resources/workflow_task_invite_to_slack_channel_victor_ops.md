...
Using `terraform import`, import rootly_workflow_task_invite_to_slack_channel_victor_ops using the `id`. For example:

```console
% terraform import rootly_workflow_task_invite_to_slack_channel_victor_ops.my-resource 00000000-0000-0000-0000-000000000000
```
