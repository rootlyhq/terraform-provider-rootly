...
Using `terraform import`, import rootly_dashboard_panel using the `id`. For example:

```console
% terraform import rootly_dashboard_panel.my-resource 00000000-0000-0000-0000-000000000000
```
