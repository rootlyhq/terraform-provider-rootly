...
Using `terraform import`, import rootly_schedule using the `id`. For example:

```console
% terraform import rootly_schedule.my-resource 00000000-0000-0000-0000-000000000000
```
