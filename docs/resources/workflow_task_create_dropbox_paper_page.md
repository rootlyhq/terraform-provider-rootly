...
rootly_workflow_task_create_dropbox_paper_page can be imported using the [`import` command](https://developer.hashicorp.com/terraform/cli/commands/import).

```sh
terraform import rootly_workflow_task_create_dropbox_paper_page.primary a816421c-6ceb-481a-87c4-585e47451f24
```
...
```terraform
import {
  to = rootly_workflow_task_create_dropbox_paper_page.primary
