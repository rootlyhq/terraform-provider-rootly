...
Using `terraform import`, import rootly_escalation_policy using the `id`. For example:

```console
% terraform import rootly_escalation_policy.my-resource 00000000-0000-0000-0000-000000000000
```
