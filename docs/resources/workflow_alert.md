...
Using `terraform import`, import rootly_workflow_alert using the `id`. For example:

```console
% terraform import rootly_workflow_alert.my-resource 00000000-0000-0000-0000-000000000000
```
