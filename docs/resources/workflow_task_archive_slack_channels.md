...
Using `terraform import`, import rootly_workflow_task_archive_slack_channels using the `id`. For example:

```console
% terraform import rootly_workflow_task_archive_slack_channels.my-resource 00000000-0000-0000-0000-000000000000
```
