...
type OverrideShift struct {
	ID            string                 `jsonapi:"primary,shifts"` // API returns shifts instead of override_shifts
	...
	UserId        string                 `jsonapi:"attr,user_id,omitempty"` // For CREATE/UPDATE
	User          map[string]interface{} `jsonapi:"attr,user,omitempty"`    // For GET
}
