...
func (c *Client) GetIncidentRoleTask(id string) (*IncidentRoleTask, error) {
	...
	resp, err := c.Do(req)
	if err != nil {
		return nil, errors.Errorf("Failed to make request to get incident_role_task: %s", id)
	}
...
func (c *Client) UpdateIncidentRoleTask(id string, incident_role_task *IncidentRoleTask) (*IncidentRoleTask, error) {
	...
	resp, err := c.Do(req)
	if err != nil {
		return nil, errors.Errorf("Failed to make request to update incident_role_task: %s", id)
	}
...
func (c *Client) DeleteIncidentRoleTask(id string) error {
	...
	_, err = c.Do(req)
	if err != nil {
		return errors.Errorf("Failed to make request to delete incident_role_task: %s", id)
	}
