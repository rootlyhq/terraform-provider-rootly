...
func (c *Client) GetWebhooksEndpoint(id string) (*WebhooksEndpoint, error) {
	req, err := rootlygo.NewGetWebhooksEndpointRequest(c.Rootly.Server, rootlygo.ID(id))
	if err != nil {
		return nil, fmt.Errorf("Error building request: %w", err)
	}
...
func (c *Client) UpdateWebhooksEndpoint(id string, webhooks_endpoint *WebhooksEndpoint) (*WebhooksEndpoint, error) {
	...
	req, err := rootlygo.NewUpdateWebhooksEndpointRequestWithBody(c.Rootly.Server, rootlygo.ID(id), c.ContentType, buffer)
	if err != nil {
		return nil, fmt.Errorf("Error building request: %w", err)
	}
	resp, err := c.Do(req)
...
func (c *Client) DeleteWebhooksEndpoint(id string) error {
	req, err := rootlygo.NewDeleteWebhooksEndpointRequest(c.Rootly.Server, rootlygo.ID(id))
	if err != nil {
