...
func (c *Client) GetCustomFieldOption(id string) (*CustomFieldOption, error) {
	...
	resp, err := c.Do(req)
	if err != nil {
		return nil, errors.Errorf("Failed to make request to get custom_field_option: %s", err.Error())
	}
...
func (c *Client) UpdateCustomFieldOption(id string, custom_field_option *CustomFieldOption) (*CustomFieldOption, error) {
	...
	resp, err := c.Do(req)
	if err != nil {
		return nil, errors.Errorf("Failed to make request to update custom_field_option: %s", err.Error())
	}
...
func (c *Client) DeleteCustomFieldOption(id string) error {
	...
	_, err = c.Do(req)
	if err != nil {
		return errors.Errorf("Failed to make request to delete custom_field_option: %s", err.Error())
	}
